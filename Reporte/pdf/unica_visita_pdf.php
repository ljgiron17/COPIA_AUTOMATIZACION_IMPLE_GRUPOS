...
$resultado = mysqli_query($connection, $sql);
	...
	if(empty($row) || $row['labora_dentro']=='NO')
		{
			echo '<script>alert("La supervisión para este alumno aún no ha sido generada ó no labora dentro de la empresa.");window.location.href="../vistas/gestion_practicantes_vista.php";</script>';
		}
		else
		{
