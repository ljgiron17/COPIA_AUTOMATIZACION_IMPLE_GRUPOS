...
function myFunction1(){                    
    var a = document.getElementById("jornada");
    ...
    var a = document.getElementById("descripcion");
    a.value = a.value.toUpperCase();
    }
    
    function myFunction3(){                    
      var a = document.getElementById("comision");
      a.value = a.value.toUpperCase();
      }
    
    function myFunction4(){                    
    var a = document.getElementById("carrera");
    a.value = a.value.toUpperCase();
    }
    ...
    var a = document.getElementById("grado_academico");
    a.value = a.value.toUpperCase();
    }
