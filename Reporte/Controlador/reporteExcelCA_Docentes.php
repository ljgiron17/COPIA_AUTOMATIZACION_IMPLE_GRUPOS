...
header("Content-Disposition: attachment; filename=reporte-docente.xls");
...
<table border="1">
    <thead>
        ...
        <tr>
            ...
            <th colspan="2">NOMBRE ASIGNATURA</th>
            ...
            <th colspan="2" style="text-align: center;"><?php echo utf8_decode("DÍAS"); ?></th>
    ...
    <tbody>
        ...
        ?>
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: center;"><?php echo utf8_decode($reg['asignatura']); ?></td>
                ...
                <td colspan="2" style="text-align: center;"><?php echo $reg['dia']; ?></td>
