...
class myPDF extends FPDF
{
    function header()
    {
        ...
        $this->Cell(330, 10, utf8_decode("REPORTE DE MANTENIMIENTO COMISIONES"), 0, 0, 'C');
        $this->ln(17);
        $this->SetFont('Arial', '', 12);
        $this->Cell(60, 10, utf8_decode("COMISIONES EXISTENTES"), 0, 0, 'C');
    ...
    function headerTable()
    {
        ...
        $this->Cell(130, 7, utf8_decode("COMISIÓN"), 1, 0, 'C');
        $this->Cell(70, 7, utf8_decode("CARRERA"), 1, 0, 'C');
