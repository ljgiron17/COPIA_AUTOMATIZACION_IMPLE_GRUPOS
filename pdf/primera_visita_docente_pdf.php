...
$resultado = mysqli_query($connection, $sql);
		...
		{
			echo '<script>alert("La primera supervisión para este alumno aún no ha sido generada ó no labora dentro de la empresa.");window.location.href="../vistas/supervisiones_realizadas_vista.php";</script>';
		}
		else
		{
