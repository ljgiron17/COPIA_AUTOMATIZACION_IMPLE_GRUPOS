...
if ($visualizacion == 0) {
    ...
    bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'Ingreso', 'A Mantenimiento Tipos de Faltas');
...
$sql2 = $mysqli->prepare("  SELECT  tbl_voae_tipos_faltas.id_falta AS id_falta, 
                                    tbl_voae_tipos_faltas.nombre_falta AS nombre_falta, 
                                    tbl_voae_tipos_faltas.descripcion_falta AS descripcion_falta 
