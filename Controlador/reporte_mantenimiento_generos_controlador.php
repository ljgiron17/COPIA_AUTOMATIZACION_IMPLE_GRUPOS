...
class myPDF extends FPDF
{
    function header()
    {
        ...
        $this->Cell(330, 10, utf8_decode("REPORTE DE MANTENIMIENTO GÉNERO"), 0, 0, 'C');
        $this->ln(17);
        $this->SetFont('Arial', '', 12);
        $this->Cell(60, 10, utf8_decode("GÉNEROS EXISTENTES"), 0, 0, 'C');
    ...
    function headerTable()
    {
        ...
        $this->Cell(60, 7, utf8_decode("GÉNERO"), 1, 0, 'C');
    ...
    function viewTable()
    {
        ...
        while ($reg = $stmt->fetch_array(MYSQLI_ASSOC)) {
            ...
            $this->Cell(60, 7, utf8_decode($reg['genero']), 1, 0, 'C');
