...
else
{
  ...
  $sql = "call proc_eliminar_edificio('$edificio'); ";
  $resultado = $mysqli->query($sql);
	if($resultado === TRUE){
      bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'],'ELIMINO' , 'EL EDIFICIO  '.ctype_upper($edificio).'');
