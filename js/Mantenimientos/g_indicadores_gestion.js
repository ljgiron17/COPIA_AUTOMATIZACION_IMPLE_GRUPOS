...
{
	bootbox.confirm("¿Está Seguro de desactivar el indicador de gestión ?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro de activar el indicador de gestión ?", function(result){
		if(result)
        {
